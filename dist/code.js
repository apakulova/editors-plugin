...
function restoreTypographicDevelopmentMarkers(input) {
    try {
...
function isTypographicDevelopmentMarker(input, index) {
    try {
...
function isOpeningQuote(input, index, stack, lastQuoteWasOpening) {
    var _a;
    try {
