  ...
  rules: [
    ...
    },
    {
      ...
      points: [
        ...
        "Без точки: <span class=\"rule-example\">млн, млрд, трлн, б-р, пр-т</span>; после числа&nbsp;— <span class=\"rule-example\">с, м, км, кг, мм, см, л, мл, В, Вт, кВт, dpi, lpi</span>",
    ...
    },
    {
      ...
      points: [
        ...
        "Между числом и&nbsp;единицей: <span class=\"rule-example\">5<span style=\"color:#FF4053\">*</span>кг, 20<span style=\"color:#FF4053\">*</span>°C, 300<span style=\"color:#FF4053\">*</span>dpi</span>",
        "Между словами <span class=\"rule-example\">скидка</span>, <span class=\"rule-example\">кешбэк/кэшбэк</span>, <span class=\"rule-example\">ставка</span>, <span class=\"rule-example\">комиссия</span>, <span class=\"rule-example\">доходность</span>, <span class=\"rule-example\">рассрочка</span>, <span class=\"rule-example\">налог</span>, <span class=\"rule-example\">НДС</span> и&nbsp;числом с&nbsp;процентом: <span class=\"rule-example\">со&nbsp;скидкой<span style=\"color:#FF4053\">*</span>7%</span>",
    ...
    },
    {
      ...
      points: [
        ...
        "Градусы и&nbsp;температура: <span class=\"rule-example\">20 ° <span class=\"rule-arrow\">→</span> 20°, 20 C <span class=\"rule-arrow\">→</span> 20&nbsp;°C, 100F <span class=\"rule-arrow\">→</span> 100&nbsp;°F</span>",
