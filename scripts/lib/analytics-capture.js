...
const FAILURE_PROPERTIES = [
  ...
  "original_error_fingerprint",
  "original_error_location",
  "original_error_name",
  "original_error_operation",
  "original_error_stage",
  "rollback_error_fingerprint",
  "rollback_error_name",
...
function validateAnalyticsStringProperty(key, value) {
  ...
  const patterns = {
    ...
    original_error_location: /^[A-Za-z0-9_./:-]+$/,
    original_error_name: /^[A-Za-z][A-Za-z0-9_]{0,99}$/,
    original_error_operation: /^[a-z0-9_]+$/,
    original_error_stage: /^[a-z0-9_]+$/,
    plugin_release: /^\d{4}-\d{2}-\d{2}$/,
    point_editing_phase: /^[a-z0-9_]+$/,
    rollback_error_fingerprint: /^[a-z0-9]+$/,
    rollback_error_name: /^[A-Za-z][A-Za-z0-9_]{0,99}$/,
    rollback_failure_operation: /^[a-z0-9_]+$/,
    rollback_failure_reason: /^[a-z0-9_]+$/,
    rollback_verification_failures: /^[a-z0-9_]+(?:,[a-z0-9_]+)*$/,
